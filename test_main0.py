...
from_path = Path("output") / "main" / f"{max_times}-{exploration_rate_min:.4f}" / "base"
to_path = Path("output") / "test" / f"{max_times}-{exploration_rate_min:.4f}" / "base"
...
top = 1000
logger = TestLogger(save_dir=to_path, top=top, name="test-base")
